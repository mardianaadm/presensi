          ...
          <!-- /.box-header -->
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <input type="text" name="NISN" class="form-control" id="inputNISN" placeholder="NISN" required>
								</div></br>
                <!-- UNDUH TEMPLATE -->
                <div class="col-sm-4 pull-right">
									<button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-unduhtemplate">Unduh Template</button>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" name="NIS" class="form-control" id="inputNIS" placeholder="NIS" required>
								</div></br>
								<!-- UNGGAH FILE -->
								<div class="col-sm-4 pull-right">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" name="nama_siswa" class="form-control" id="inputNama" placeholder="Nama" required>
								</div>
							</div></br>
							@foreach($kelas_siswa as $datakelas)
							<input type="hidden" name="data_kelas_siswa" class="form-control" id="data_kelas_siswa" placeholder="data_kelas_siswa" value="{{$datakelas->id_kelas_siswa}}">
							@endforeach
							<div class="form-group">
								...
								<div class="col-sm-4">
									...
									<input type="hidden" name="tahun_ajaran" value="{{$value->id_tahun_ajaran}}" readonly="">
									<input type="text" class="form-control" name="nama_tahun_ajaran" value="{{$value->masa_tahun_ajaran}}" readonly="">
									@endif
									@endforeach
								</div>
							</div>
